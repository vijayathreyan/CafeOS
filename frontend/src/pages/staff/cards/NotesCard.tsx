...
interface Props { dailyEntryId: string }
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex justify-end mt-3">
        <button onClick={handleSave} className={`btn-secondary text-sm px-4 py-2 ${saved ? 'border-secondary text-secondary' : ''}`} disabled={saving}>
